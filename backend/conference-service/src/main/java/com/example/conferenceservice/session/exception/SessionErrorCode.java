...
public enum SessionErrorCode implements ErrorCode {
    ...
    SESSION_RESERVATION_SERVICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "SESSION_RESERVATION_SERVICE_UNAVAILABLE", "예약 현황을 확인할 수 없어 세션 수정을 처리할 수 없습니다."),
    SESSION_CAPACITY_EXCEEDS_CONFERENCE_CAPACITY(HttpStatus.CONFLICT, "SESSION_CAPACITY_EXCEEDS_CONFERENCE_CAPACITY", "세션 정원은 컨퍼런스 정원을 초과할 수 없습니다.");
