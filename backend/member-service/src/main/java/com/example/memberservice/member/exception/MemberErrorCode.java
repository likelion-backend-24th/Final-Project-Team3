...
public enum MemberErrorCode implements ErrorCode {
    ...
    WITHDRAWAL_PASSWORD_MISMATCH(HttpStatus.UNAUTHORIZED, "MEMBER_WITHDRAWAL_PASSWORD_MISMATCH", "비밀번호가 일치하지 않습니다."),
    WITHDRAWAL_SOCIAL_IDENTITY_MISMATCH(HttpStatus.UNAUTHORIZED, "MEMBER_WITHDRAWAL_SOCIAL_IDENTITY_MISMATCH", "본인 계정에 연동되지 않은 소셜 계정입니다."),
    WITHDRAWAL_ELIGIBILITY_CHECK_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "MEMBER_WITHDRAWAL_ELIGIBILITY_CHECK_FAILED", "탈퇴 가능 여부 확인에 실패했습니다. 잠시 후 다시 시도해주세요."),
    ORGANIZER_WITHDRAWAL_BLOCKED(HttpStatus.CONFLICT, "MEMBER_ORGANIZER_WITHDRAWAL_BLOCKED", "진행 중인 컨퍼런스 또는 미완료 정산 건이 있어 탈퇴할 수 없습니다."),
