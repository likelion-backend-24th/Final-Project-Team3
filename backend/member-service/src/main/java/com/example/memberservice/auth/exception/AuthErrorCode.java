...
public enum AuthErrorCode implements ErrorCode {
    ...
    PASSWORD_RESET_SOCIAL_ONLY_ACCOUNT(HttpStatus.CONFLICT, "AUTH_PASSWORD_RESET_SOCIAL_ONLY_ACCOUNT", "소셜 로그인으로만 가입된 계정은 비밀번호 재설정을 할 수 없습니다."),
    PASSWORD_RESET_CODE_INVALID(HttpStatus.BAD_REQUEST, "AUTH_PASSWORD_RESET_CODE_INVALID", "인증코드가 올바르지 않습니다."),
    PASSWORD_RESET_CODE_EXPIRED(HttpStatus.BAD_REQUEST, "AUTH_PASSWORD_RESET_CODE_EXPIRED", "인증코드가 만료되었습니다. 다시 요청해주세요."),
    PASSWORD_RESET_ATTEMPTS_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "AUTH_PASSWORD_RESET_ATTEMPTS_EXCEEDED", "인증 시도 횟수를 초과했습니다. 다시 요청해주세요."),
    PASSWORD_RESET_RESEND_TOO_SOON(HttpStatus.TOO_MANY_REQUESTS, "AUTH_PASSWORD_RESET_RESEND_TOO_SOON", "잠시 후 다시 시도해주세요.");
